...
class Func {
  ...
  constructor(options) {
    ...
    this.logger = this.initLogger(Object.assign(options, { LOG_LEVEL: this.LOG_LEVEL }))
  }
  ...
  async invoke(ctx, options) {
    ...
    try {
      ...
      throw ctx.error // err but processed by this.handleError
    } 
...
class ConsoleLogger {
  ...
  line(args) {
    ...
    return this.prettify && this.prettify(line) || JSON.stringify(line)
  }
}
